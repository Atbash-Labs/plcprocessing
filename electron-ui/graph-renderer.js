...
class GraphRenderer {
  ...
  _getGroupForType(type) {
    const typeMap = {
      ...
      'Tag': 'plc', 'tag': 'plc',
      'UDT': 'scada', 'udt': 'scada',
      'Equipment': 'scada', 'equipment': 'scada',
      'View': 'scada', 'view': 'scada',
      'ViewComponent': 'scada-component', 'viewcomponent': 'scada-component',
      'Script': 'scada', 'script': 'scada',
      'NamedQuery': 'scada', 'namedquery': 'scada',
      'Project': 'scada', 'project': 'scada',
      'ScadaTag': 'scada-tag', 'scadatag': 'scada-tag',
      'GatewayEvent': 'scada', 'gatewayevent': 'scada',
      'FaultSymptom': 'troubleshooting', 'faultsymptom': 'troubleshooting',
      'FaultCause': 'troubleshooting', 'faultcause': 'troubleshooting',
      'Material': 'mes', 'material': 'mes',
      'Batch': 'mes', 'batch': 'mes',
      'Operation': 'mes', 'operation': 'mes',
      'CCP': 'mes', 'ccp': 'mes',
      'ProductionOrder': 'mes', 'productionorder': 'mes',
      // Siemens TIA Portal project types
      'TiaProject': 'siemens', 'tiaproject': 'siemens',
      'PLCDevice': 'siemens', 'plcdevice': 'siemens',
      'HMIDevice': 'siemens', 'hmidevice': 'siemens',
      'HMIConnection': 'siemens', 'hmiconnection': 'siemens',
      'HMIAlarm': 'siemens-hmi', 'hmialarm': 'siemens-hmi',
      'HMIAlarmClass': 'siemens-hmi', 'hmialarmclass': 'siemens-hmi',
      'HMIScript': 'siemens-hmi', 'hmiscript': 'siemens-hmi',
      'HMITagTable': 'siemens-hmi', 'hmitagtable': 'siemens-hmi',
      'HMITextList': 'siemens-hmi', 'hmitextlist': 'siemens-hmi',
